...
{
	cout << "-----> Uso: ./practica2 nombreFichero.py numeroIteraciones(será 15 por defecto). <----" << endl;
	return 1;
...
glutCreateWindow("Práctica 2: Victor Vallecillo Morilla");
